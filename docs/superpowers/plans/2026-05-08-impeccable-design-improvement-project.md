...
- [x] **S2.1** — `home_shell` + `_home_live` (converged: 2026-05-08, S2.1.2)
  ...
  - [x] S2.1.2 (commit: PENDING) — heur 28→32/40 (re-critique pre/post), audit 16→18/20, anti-pat 0→0. Gate: **PASS** (0 P0, 0 unrouted P1, 0 anti-pat, heur ≥ 32). 4 of 6 inherited backlog items closed; 2 routed forward (sparkline delight + a11y polish) to S2.1.3.
