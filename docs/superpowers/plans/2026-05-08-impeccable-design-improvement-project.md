...
- [ ] **S6.1** — cross-phase polish (converged: ___). Sweep §0.4 → 19 routed items in 10 primitive groups (see §8). Expect 2-4 iterations per §1.5c (3-5 triage outcomes each).
