...
- [ ] **Step 2a: Update CLAUDE.md if any patterns warrant locking** (e.g., reusable component shapes that emerged from S6.1's primitive ratifications, new tokens, regression-test patterns).
- [ ] **Step 2b: Clean up this plan to reflect a final and completed state. Ensure boxes are [x] so Brad can track finished progressed.**
