...
- [ ] **Phase 5 — Changeover PR** (~Aug 17–24): the atomic double flip + test/copy/CLAUDE.md updates (§6 E). **Paste-ready kit prepared 2026-07-30:** `2026-07-30-phase5-changeover-kit.md` (exact diffs, auth-callout Jinja/CSS, the three CFB commish notes, smoke checklist, early §6F readiness results).
